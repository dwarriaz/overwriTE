    ...
    def classification(self):
        ...
        if self.genoStrand == '+':
            if self.repStart < self.txStart:
                return self.package('Promoter_Region',len(range(self.repStart, self.repEnd,1)),1500)   
                ...
                return self.package ('3_End_Region',len(range(self.repStart, self.repEnd,1)),300)
                ...
                for x in range (0,len(exonstartlist)):
                    ...
                    if len(calculation) == 0:
                        return self.package('Intron', repLen,(self.txStart-self.txEnd-totalExonLength))
            ...
            if self.repStart > self.txEnd:
                ...
                totalExonLength = int()
                for x in range(0,len(exonstartlist)):
                    totalExonLength += (exonstartlist[x]-exonstoplist[x])
                ...
                for x in range(0,len(exonstartlist)):
                    ...
                    if len(calculation) == 0:
                        ...
                        return self.package('Exon', len(calculation),totalExonLength)
                    elif len(calculation) > 1 and len(calculation) != repLen: 
                        return self.package('Junction', len(calculation),len(calculation))
